...
{
  portlet.setTitle("Cancellation Budget vs Actual");
    
    /********************* BUDGET ********************/

    var filters = [];
    filters.push(new nlobjSearchFilter('internalid', null, 'is', 105));
    ...
    */
        // Product
        var q1_pc1_act = getActualPerPeriod('customsearch2776', '4/1/2018', '6/30/2018', 6);
        var q2_pc1_act = getActualPerPeriod('customsearch2776', '7/1/2018', '9/30/2018', 6);
        var q3_pc1_act = getActualPerPeriod('customsearch2776', '10/1/2018', '12/31/2018', 6);
        var q4_pc1_act = getActualPerPeriod('customsearch2776', '1/1/2019', '3/31/2019', 6);
        var fyt_pc1_act = q1_pc1_act + q2_pc1_act + q3_pc1_act + q4_pc1_act;

        var q1_pc2_act = getActualPerPeriod('customsearch2777', '4/1/2018', '6/30/2018', 6);
        var q2_pc2_act = getActualPerPeriod('customsearch2777', '7/1/2018', '9/30/2018', 6);
        var q3_pc2_act = getActualPerPeriod('customsearch2777', '10/1/2018', '12/31/2018', 6);
        var q4_pc2_act = getActualPerPeriod('customsearch2777', '1/1/2019', '3/31/2019', 6);
        var fyt_pc2_act = q1_pc2_act + q2_pc2_act + q3_pc2_act + q4_pc2_act;

        var q1_pc3_act = getActualPerPeriod('customsearch2778', '4/1/2018', '6/30/2018', 6);
        var q2_pc3_act = getActualPerPeriod('customsearch2778', '7/1/2018', '9/30/2018', 6);
        var q3_pc3_act = getActualPerPeriod('customsearch2778', '10/1/2018', '12/31/2018', 6);
        var q4_pc3_act = getActualPerPeriod('customsearch2778', '1/1/2019', '3/31/2019', 6);
        ...
        // Region
        var q1_reg1_act = getActualPerPeriod('customsearch2776', '4/1/2018', '6/30/2018', 6);
        var q2_reg1_act = getActualPerPeriod('customsearch2776', '7/1/2018', '9/30/2018', 6);
        var q3_reg1_act = getActualPerPeriod('customsearch2776', '10/1/2018', '12/31/2018', 6);
        var q4_reg1_act = getActualPerPeriod('customsearch2776', '1/1/2019', '3/31/2019', 6);
        var fyt_reg1_act = q1_reg1_act + q2_reg1_act + q3_reg1_act + q4_reg1_act;

        var q1_reg2_act = getActualPerPeriod('customsearch2777', '4/1/2018', '6/30/2018', 5);
        var q2_reg2_act = getActualPerPeriod('customsearch2777', '7/1/2018', '9/30/2018', 5);
        var q3_reg2_act = getActualPerPeriod('customsearch2777', '10/1/2018', '12/31/2018', 5);
        var q4_reg2_act = getActualPerPeriod('customsearch2777', '1/1/2019', '3/31/2019', 5);
        var fyt_reg2_act = q1_reg2_act + q2_reg2_act + q3_reg2_act + q4_reg2_act;

        var q1_reg3_act = getActualPerPeriod('customsearch2778', '4/1/2018', '6/30/2018', 5);
        var q2_reg3_act = getActualPerPeriod('customsearch2778', '7/1/2018', '9/30/2018', 5);
        var q3_reg3_act = getActualPerPeriod('customsearch2778', '10/1/2018', '12/31/2018', 5);
        var q4_reg3_act = getActualPerPeriod('customsearch2778', '1/1/2019', '3/31/2019', 5);
          ...
          if (!results || results.length == 0)
    {
        ...
        content += ".value_col_3 { text-align:left; padding-left: 10px; padding-right : 10px; color: rgb(0, 0, 0)}";
