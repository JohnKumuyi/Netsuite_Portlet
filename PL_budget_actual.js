function listPortlet(portlet, column)
{
  ...
  // New Line  
    cols.push(new nlobjSearchColumn('custrecord_kpi_label_4'));
  // New Line  
...
// New Line  
    cols.push(new nlobjSearchColumn('custrecord_kpi_q1_f4'));
    cols.push(new nlobjSearchColumn('custrecord_kpi_q2_f4'));
    cols.push(new nlobjSearchColumn('custrecord_kpi_q3_f4'));
    cols.push(new nlobjSearchColumn('custrecord_kpi_q4_f4'));
    cols.push(new nlobjSearchColumn('custrecord_kpi_fyt_f4'));
// New Line  
...
// New Line  
    cols.push(new nlobjSearchColumn('custrecord_kpi_as_reg4'));
// New Line  
    ...
    if (results && results.length > 0)
    {
      ...
      // New Line  
        var pc4 = element.getText(cols[31]);
      // New Line   
        var q1_pc1 = element.getValue(cols[32]);
        var q2_pc1 = element.getValue(cols[33]);
        var q3_pc1 = element.getValue(cols[34]);
        var q4_pc1 = element.getValue(cols[35]);
        var fyt_pc1 = element.getValue(cols[36]);

        var q1_pc2 = element.getValue(cols[37]);
        var q2_pc2 = element.getValue(cols[38]);
        var q3_pc2 = element.getValue(cols[39]);
        var q4_pc2 = element.getValue(cols[40]);
        var fyt_pc2 = element.getValue(cols[41]);

        var q1_pc3 = element.getValue(cols[42]);
        var q2_pc3 = element.getValue(cols[43]);
        var q3_pc3 = element.getValue(cols[44]);
        var q4_pc3 = element.getValue(cols[45]);
        var fyt_pc3 = element.getValue(cols[46]);
// New Line  
        var q1_pc4 = element.getValue(cols[47]);
        var q2_pc4 = element.getValue(cols[48]);
        var q3_pc4 = element.getValue(cols[49]);
        var q4_pc4 = element.getValue(cols[50]);
        var fyt_pc4 = element.getValue(cols[51]);
// New Line  
        var q1_act_label = element.getValue(cols[52]);
        var q2_act_label = element.getValue(cols[53]);
        var q3_act_label = element.getValue(cols[54]);
        var q4_act_label = element.getValue(cols[55]);
        var fyt_act_label = element.getValue(cols[56]);
        var diff_label = element.getValue(cols[57]);

        var link_pc_1 =  element.getValue(cols[58]);
        var link_pc_2 =  element.getValue(cols[59]);
        var link_pc_3 =  element.getValue(cols[60]);
 // New Line  
        var link_pc_4 =  element.getValue(cols[61]);
// New Line  
        var link_reg_1 =  element.getValue(cols[62]);
        var link_reg_2 =  element.getValue(cols[63]);
        var link_reg_3 =  element.getValue(cols[64]);
...
// New Line  
        var q1_pc4_act = getActualPerPeriod('customsearch2546', '4/1/2018', '6/30/2018', 6);
        var q2_pc4_act = getActualPerPeriod('customsearch2546', '7/1/2018', '9/30/2018', 6);
        var q3_pc4_act = getActualPerPeriod('customsearch2546', '10/1/2018', '12/31/2018', 6);
        var q4_pc4_act = getActualPerPeriod('customsearch2546', '1/1/2019', '3/31/2019', 6);
        var fyt_pc4_act = q1_pc4_act + q2_pc4_act + q3_pc4_act + q4_pc4_act;
// New Line  
        var q1_pc_act_total = (q1_pc1_act*1 + q1_pc2_act*1 + q1_pc3_act*1 + q1_pc4_act*1) * 1;
        var q2_pc_act_total = (q2_pc1_act*1 + q2_pc2_act*1 + q2_pc3_act*1 + q2_pc4_act*1) * 1;
        var q3_pc_act_total = (q3_pc1_act*1 + q3_pc2_act*1 + q3_pc3_act*1 + q3_pc4_act*1) * 1;
        var q4_pc_act_total = (q4_pc1_act*1 + q4_pc2_act*1 + q4_pc3_act*1 + q4_pc4_act*1) * 1;
        var fyt_pc_act_total = (fyt_pc1_act*1 + fyt_pc2_act*1 + fyt_pc3_act*1 + fyt_pc4_act*1) * 1;
...
// New Line  
 /*       content += "<tr>";
        content += "<td class='value_col_2'>" + pc4 + "</td>";

        content += "<td class='value_col budget_col'>" + addCommas(parseFloat(q1_pc4*1)) + "</td>";
        content += "<td class='value_col actual_col'><a target='_blank' href='"+ link_pc_4+q1_param +"'>"  + addCommas(parseFloat(q1_pc3_act*1)) + "</a></td>";
        content += "<td class='value_col diff'>" + addCommas(parseFloat(Math.round(q1_pc4_act*1/q1_pc4*100))) + " %</td>";

        content += "<td class='value_col budget_col'>" + addCommas(parseFloat(q2_pc4*1)) + "</td>";
        content += "<td class='value_col actual_col'><a target='_blank' href='"+ link_pc_4+q2_param +"'>" + addCommas(parseFloat(q2_pc4_act*1)) + "</a></td>";
        content += "<td class='value_col diff'>" + addCommas(parseFloat(Math.round(q2_pc4_act*1/q2_pc4*100))) + " %</td>";

        content += "<td class='value_col budget_col'>" + addCommas(parseFloat(q3_pc4*1)) + "</td>";
        content += "<td class='value_col actual_col'><a target='_blank' href='"+ link_pc_4+q3_param +"'>" + addCommas(parseFloat(q3_pc4_act*1)) + "</a></td>";
        content += "<td class='value_col diff'>" + addCommas(parseFloat(Math.round(q3_pc4_act*1/q3_pc4*100))) + " %</td>";

        content += "<td class='value_col budget_col'>" + addCommas(parseFloat(q4_pc4*1)) + "</td>";
        content += "<td class='value_col actual_col'><a target='_blank' href='"+ link_pc_4+q4_param +"'>" + addCommas(parseFloat(q4_pc4_act*1)) + "</a></td>";
        content += "<td class='value_col diff'>" + addCommas(parseFloat(Math.round(q4_pc4_act*1/q4_pc4*100))) + " %</td>";

        content += "<td class='value_col budget_col'>" + addCommas(parseFloat(fyt_pc4*1)) + "</td>";
        content += "<td class='value_col actual_col'><a target='_blank' href='"+ link_pc_4+fy_param +"'>" + addCommas(parseFloat(fyt_pc4_act*1)) + "</a></td>";
        content += "<td class='value_col diff'>" + addCommas(parseFloat(Math.round(fyt_pc4_act*1/fyt_pc4*100))) + " %</td>";
        content += "</tr>";*/
// New Line  
        content += "<tr class='total'>";
        var q1_pc_total = (q1_pc1*1 + q1_pc2*1 + q1_pc3*1 + q1_pc4*1) * 1;
        var q2_pc_total = (q2_pc1*1 + q2_pc2*1 + q2_pc3*1 + q2_pc4*1) * 1;
        var q3_pc_total = (q3_pc1*1 + q3_pc2*1 + q3_pc3*1 + q3_pc4*1) * 1;
        var q4_pc_total = (q4_pc1*1 + q4_pc2*1 + q4_pc3*1 + q4_pc4*1) * 1;
        var fyt_pc_total = (fyt_pc1*1 + fyt_pc2*1 + fyt_pc3*1 + fyt_pc4*1) * 1;
