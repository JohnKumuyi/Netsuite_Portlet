function listPortlet(portlet, column)
{
    ...
    var filters = [];
    filters.push(new nlobjSearchFilter('internalid', null, 'is', 4));
    ...
    // Portlet Title
    cols.push(new nlobjSearchColumn('custrecord_kpi_title'));
    ...
    if (results && results.length > 0)
    {
        ...
        portletTitle = element.getValue(cols[58]);
    ...
    /********************* ACTUAL ********************/
        /********************** ACV ***********************/
        // Product
        var q1_pc1 = getActualPerPeriod('customsearch2766', '4/1/2018', '6/30/2018', 6);
        var q2_pc1 = getActualPerPeriod('customsearch2766', '7/1/2018', '9/30/2018', 6);
        var q3_pc1 = getActualPerPeriod('customsearch2766', '10/1/2018', '12/31/2018', 6);
        var q4_pc1 = getActualPerPeriod('customsearch2766', '1/1/2019', '3/31/2019', 6);
        var fyt_pc1 = q1_pc1 + q2_pc1 + q3_pc1 + q4_pc1;

        var q1_pc2 = getActualPerPeriod('customsearch2767', '4/1/2018', '6/30/2018', 5);
        var q2_pc2 = getActualPerPeriod('customsearch2767', '7/1/2018', '9/30/2018', 5);
        var q3_pc2 = getActualPerPeriod('customsearch2767', '10/1/2018', '12/31/2018', 5);
        var q4_pc2 = getActualPerPeriod('customsearch2767', '1/1/2019', '3/31/2019', 5);
        var fyt_pc2 = q1_pc2 + q2_pc2 + q3_pc2 + q4_pc2;

        
        var q1_pc3 = getActualPerPeriod('customsearch2768', '4/1/2018', '6/30/2018', 5);
        var q2_pc3 = getActualPerPeriod('customsearch2768', '7/1/2018', '9/30/2018', 5);
        var q3_pc3 = getActualPerPeriod('customsearch2768', '10/1/2018', '12/31/2018', 5);
        var q4_pc3 = getActualPerPeriod('customsearch2768', '1/1/2019', '3/31/2019', 5);
        var fyt_pc3 = q1_pc3 + q2_pc3 + q3_pc3 + q4_pc3;

        // Region
        var q1_reg1 = getActualPerPeriod('customsearch2769', '4/1/2018', '6/30/2018', 5);
        var q2_reg1 = getActualPerPeriod('customsearch2769', '7/1/2018', '9/30/2018', 5);
        var q3_reg1 = getActualPerPeriod('customsearch2769', '10/1/2018', '12/31/2018', 5);
        var q4_reg1 = getActualPerPeriod('customsearch2769', '1/1/2019', '3/31/2019', 5);
        var fyt_reg1 = q1_reg1 + q2_reg1 + q3_reg1 + q4_reg1;

        var q1_reg2 = getActualPerPeriod('customsearch2770', '4/1/2018', '6/30/2018', 5);
        var q2_reg2 = getActualPerPeriod('customsearch2770', '7/1/2018', '9/30/2018', 5);
        var q3_reg2 = getActualPerPeriod('customsearch2770', '10/1/2018', '12/31/2018', 5);
        var q4_reg2 = getActualPerPeriod('customsearch2770', '1/1/2019', '3/31/2019', 5);
        var fyt_reg2 = q1_reg2 + q2_reg2 + q3_reg2 + q4_reg2;

        var q1_reg3 = getActualPerPeriod('customsearch2771', '4/1/2018', '6/30/2018', 5);
        var q2_reg3 = getActualPerPeriod('customsearch2771', '7/1/2018', '9/30/2018', 5);
        var q3_reg3 = getActualPerPeriod('customsearch2771', '10/1/2018', '12/31/2018', 5);
        var q4_reg3 = getActualPerPeriod('customsearch2771', '1/1/2019', '3/31/2019', 5);
        var fyt_reg3 = q1_reg3 + q2_reg3 + q3_reg3 + q4_reg3;


        /***************** WACV *****************/
        // Product
        var q1_pc1_act = getActualPerPeriod('customsearch2766', '4/1/2018', '6/30/2018', 7);
        var q2_pc1_act = getActualPerPeriod('customsearch2766', '7/1/2018', '9/30/2018', 7);
        var q3_pc1_act = getActualPerPeriod('customsearch2766', '10/1/2018', '12/31/2018', 7);
        var q4_pc1_act = getActualPerPeriod('customsearch2766', '1/1/2019', '3/31/2019', 7);
        var fyt_pc1_act = q1_pc1_act + q2_pc1_act + q3_pc1_act + q4_pc1_act;

        var q1_pc2_act = getActualPerPeriod('customsearch2767', '4/1/2018', '6/30/2018', 6);
        var q2_pc2_act = getActualPerPeriod('customsearch2767', '7/1/2018', '9/30/2018', 6);
        var q3_pc2_act = getActualPerPeriod('customsearch2767', '10/1/2018', '12/31/2018', 6);
        var q4_pc2_act = getActualPerPeriod('customsearch2767', '1/1/2019', '3/31/2019', 6);
        var fyt_pc2_act = q1_pc2_act + q2_pc2_act + q3_pc2_act + q4_pc2_act;

        var q1_pc3_act = getActualPerPeriod('customsearch2768', '4/1/2018', '6/30/2018', 6);
        var q2_pc3_act = getActualPerPeriod('customsearch2768', '7/1/2018', '9/30/2018', 6);
        var q3_pc3_act = getActualPerPeriod('customsearch2768', '10/1/2018', '12/31/2018', 6);
        var q4_pc3_act = getActualPerPeriod('customsearch2768', '1/1/2019', '3/31/2019', 6);
        ...
        // Region
        var q1_reg1_act = getActualPerPeriod('customsearch2769', '4/1/2018', '6/30/2018', 6);
        var q2_reg1_act = getActualPerPeriod('customsearch2769', '7/1/2018', '9/30/2018', 6);
        var q3_reg1_act = getActualPerPeriod('customsearch2769', '10/1/2018', '12/31/2018', 6);
        var q4_reg1_act = getActualPerPeriod('customsearch2769', '1/1/2019', '3/31/2019', 6);
        var fyt_reg1_act = q1_reg1_act + q2_reg1_act + q3_reg1_act + q4_reg1_act;

        var q1_reg2_act = getActualPerPeriod('customsearch2770', '4/1/2018', '6/30/2018', 6);
        var q2_reg2_act = getActualPerPeriod('customsearch2770', '7/1/2018', '9/30/2018', 6);
        var q3_reg2_act = getActualPerPeriod('customsearch2770', '10/1/2018', '12/31/2018', 6);
        var q4_reg2_act = getActualPerPeriod('customsearch2770', '1/1/2019', '3/31/2019', 6);
        var fyt_reg2_act = q1_reg2_act + q2_reg2_act + q3_reg2_act + q4_reg2_act;

        var q1_reg3_act = getActualPerPeriod('customsearch2771', '4/1/2018', '6/30/2018', 6);
        var q2_reg3_act = getActualPerPeriod('customsearch2771', '7/1/2018', '9/30/2018', 6);
        var q3_reg3_act = getActualPerPeriod('customsearch2771', '10/1/2018', '12/31/2018', 6);
        var q4_reg3_act = getActualPerPeriod('customsearch2771', '1/1/2019', '3/31/2019', 6);
